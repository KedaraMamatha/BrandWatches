...
<body>
<form:form action="supplierUser" commandName="supplier" method="post" >
<table border="1" align="center">
<tr>
<td colspan ="2" align="center"><h2>Add Supplier</h2></td>
</tr>
<tr><td>Supplier Name: <form:input path="supplierName"/> </td></tr>
<br>
<tr><td>Supplier Address: <form:input path="supplierAddress"/> </td></tr>
<br>
