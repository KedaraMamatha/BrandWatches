...
<body>
<form:form action="categoryUser" commandName="category" method="post" >
<table border="1">
<tr>
<td colspan ="2" align="center"><h2>Add Category</h2></td>
</tr>
<tr><td>Category Name: <form:input path="categoryName"/> </td></tr>
<br>
